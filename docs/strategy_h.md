...
| H6 | 上证50ETF | Dip | 6日跌>4% | 4日 | None | 0.51 | 7.5% | -20.3% | 54% | 81 |
...
- **Data snooping**: Acknowledged - variants selected from large parameter search. Mitigated by requiring statistical significance (>= 10 trades) and cross-index validation
